...
def get_stage_item_inputs_mock(tournament_id: TournamentId) -> list[StageItemInputFinal]:
    return [
        StageItemInputFinal(
            ...
            team=TeamBracket(**DUMMY_TEAM1.model_dump(), id=TeamId(-1)),
        ),
        StageItemInputFinal(
            ...
            slot=2,
            tournament_id=tournament_id,
            team=TeamBracket(**DUMMY_TEAM2.model_dump(), id=TeamId(-2)),
        ),
        StageItemInputFinal(
            id=StageItemInputId(-1),
            team_id=TeamId(-1),
            slot=3,
            tournament_id=tournament_id,
            team=TeamBracket(**DUMMY_TEAM3.model_dump(), id=TeamId(-3)),
        ),
        StageItemInputFinal(
            ...
            slot=4,
            tournament_id=tournament_id,
            team=TeamBracket(**DUMMY_TEAM4.model_dump(), id=TeamId(-4)),
        ),
    ]
