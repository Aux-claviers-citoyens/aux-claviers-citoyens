...
from bracket.models.db.tournament import TournamentPublic
...
class TournamentResponse(DataResponse[TournamentPublic]):
    pass


class TournamentsResponse(DataResponse[list[TournamentPublic]]):
    pass
...
class SingleTeamResponse(DataResponse[TeamBracket]):
    pass
