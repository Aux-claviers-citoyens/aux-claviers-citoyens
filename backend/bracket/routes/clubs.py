...
@router.get("/clubs", response_model=ClubsResponse, include_in_schema=False)
...
@router.post("/clubs", response_model=ClubResponse, include_in_schema=False)
...
@router.delete("/clubs/{club_id}", response_model=SuccessResponse, include_in_schema=False)
...
@router.put("/clubs/{club_id}", response_model=ClubResponse, include_in_schema=False)
