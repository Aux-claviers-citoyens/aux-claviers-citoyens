...
from bracket.models.db.stage_item import StageItemResponse
...
@router.post("/tournaments/{tournament_id}/stage_items", response_model=StageItemResponse)
async def create_stage_item(
    ...
    return StageItemResponse(data = stage_item)
