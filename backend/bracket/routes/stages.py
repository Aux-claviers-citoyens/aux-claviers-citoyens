...
from bracket.models.db.stage import Stage, StageActivateBody, StageUpdateBody, StageResponse
...
@router.post("/tournaments/{tournament_id}/stages", response_model=StageResponse)
async def create_stage(
    ...
    return StageResponse(data=stage)
