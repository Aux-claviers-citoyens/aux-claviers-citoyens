...
from bracket.utils.db_init import init_db_when_empty, ensure_admin_default_club_link
...
async def lifespan(_: FastAPI) -> AsyncIterator[None]:
    ...
    # Ensure the admin is linked to the default club after init/migrations
    await ensure_admin_default_club_link()
